...
pgrn <- ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2, labels = c("A1", "A2", "A3", "A4"))
pgrn
...
prgn.log <- ggarrange(p9, p10, nrow = 2, labels = c("B1", "B2"))
prgn.log
...
# arrange paper plots
tiff(paste0("/g/scb/zaugg/deuner/figs/eGRN_stats_regulons_cb_sp", ".tiff"), units="in", width=12.8, height=4.8, res=300, type = "cairo")
