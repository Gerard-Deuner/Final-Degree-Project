#!/bin/bash
#SBATCH --job-name CHIPSEQ_SETUP
#SBATCH -A zaugg
#SBATCH --nodes 1
#SBATCH --ntasks 16
#SBATCH --mem 128GB
#SBATCH --time 24:00:00
#SBATCH --output output_chipseq_setup.txt
#SBATCH --error error_chipseq_setup.txt
...
Rscript --vanilla /g/scb/zaugg/deuner/valdata/code/ChiPSeq_setup.R timecourse
