...
gs -dFirstpage=1 -dLastPage=1 -dNOPAUSE -dBATCH -sDEVICE=pdfwrite -sOutputFile=/g/scb/zaugg/deuner/GRaNIE/outputdata/batch_mode/$1_batch_mode_$2/peak_Gene_diagnosticPlots_all/peak_Gene_diagnosticPlots_all_MERGED.pdf *.pdf
