...
# The odds ratio of the GRN links over the random distance-matched links being validated by eQTLs is:** `r round(mean_or, digits = 3)` (range `r round(min_or, digits = 3)`-`r round(max_or, digits = 3)`)
