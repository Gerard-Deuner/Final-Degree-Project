...
FeatureScatter(timecourse.s, feature1 = "nCount_RNA", feature2 = "percent.ribo")
...
# Non random distribution of percent.mt, normalise again with SCTtransform excluding this variable
